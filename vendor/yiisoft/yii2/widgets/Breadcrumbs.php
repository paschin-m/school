 ...
 *
 * ```php
 * // $this is the views object currently being used
 * echo Breadcrumbs::widget([
 *     'itemTemplate' => "<li><i>{link}</i></li>\n", // template for all links
 *     'links' => [
 *         [
 *             'label' => 'Post Category',
 *             'url' => ['post-category/views', 'id' => 10],
 ...
 * ```
 *
 * Because breadcrumbs usually appears in nearly every page of a website, you may consider placing it in a layout views.
 * You can use a views parameter (e.g. `$this->params['breadcrumbs']`) to configure the links in different
 * views. In the layout views, you assign this views parameter to the [[links]] property like the following:
 *
 * ```php
 * // $this is the views object currently being used
 * echo Breadcrumbs::widget([
