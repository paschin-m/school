...
/**
 * ContentDecorator records all output between [[begin()]] and [[end()]] calls, passes it to the given views file
 ...
 * [[\yii\base\View]] component to make syntax more friendly. In the views these could be used as follows:
 *
 * ```php
...
{
    /**
     * @var string the views file that will be used to decorate the content enclosed by this widget.
     * This can be specified as either the views file path or [path alias](guide:concept-aliases).
     */
    public $viewFile;
    /**
     * @var array the parameters (name => value) to be extracted and made available in the decorative views.
     */
    public $params = [];
