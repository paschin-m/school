...
{
    /**
     * @var array the HTML attributes for the container tag of the list views.
     * The "tag" element specifies the tag name of the container element and defaults to "div".
     * @see \yii\helpers\Html::renderTagAttributes() for details on how attributes are being rendered.
     */
    public $options = [];
    /**
     * @var \yii\data\DataProviderInterface the data provider for the views. This property is required.
     */
    public $dataProvider;
    /**
    ...
    public $sorter = [];
    /**
     * @var string the HTML content to be displayed as the summary of the list views.
    ...
    public $summary;
    /**
     * @var array the HTML attributes for the summary of the list views.
     * The "tag" element specifies the tag name of the summary element and defaults to "div".
     * @see \yii\helpers\Html::renderTagAttributes() for details on how attributes are being rendered.
     */
    public $summaryOptions = ['class' => 'summary'];
    /**
     * @var bool whether to show an empty list views if [[dataProvider]] returns no data.
    ...
    public $emptyText;
    /**
     * @var array the HTML attributes for the emptyText of the list views.
     * The "tag" element specifies the tag name of the emptyText element and defaults to "div".
     * @see \yii\helpers\Html::renderTagAttributes() for details on how attributes are being rendered.
     */
    public $emptyTextOptions = ['class' => 'empty'];
    /**
     * @var string the layout that determines how different sections of the list views should be organized.
    ...
    /**
     * Renders the HTML content indicating that the list views has no data.
     * @return string the rendering result
     * @see emptyText
     */
