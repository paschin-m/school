 ...
 * provider. Each data model is rendered using the views
 * specified.
 *
...
class ListView extends BaseListView
{
    ...
    public $itemOptions = [];
    /**
     * @var string|callable the name of the views for rendering each data item, or a callback (e.g. an anonymous function)
     * for rendering each data item. If it specifies a views name, the following variables will
     * be available in the views:
     *
     ...
     *
     * Note that the views name is resolved into the views file by the current context of the [[views]] object.
     *
     ...
     * This property is used only when [[itemView]] is a string representing a views name.
     */
    public $viewParams = [];
    /**
     ...
     * @see \yii\helpers\Html::renderTagAttributes() for details on how attributes are being rendered.
     */
    public $options = ['class' => 'list-views'];
    /**
