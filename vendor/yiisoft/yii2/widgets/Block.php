 ...
 * The general idea is that you're defining block default in a views or layout:
 *
 * ```php
...
class Block extends Widget
{
     ...
     * This method stops output buffering and saves the rendering result as a named block in the views.
     */
    public function run()
    {
        $block = ob_get_clean();
