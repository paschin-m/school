...
{
    /**
     * @var array list of ALL views names in the database
     */
    private $_viewNames = [];
     ...
     * If not empty, the returned views names will be prefixed with the schema name.
     * @param bool $refresh whether to fetch the latest available views names. If this is false,
     * views names fetched previously (if available) will be returned.
     * @return string[] all views names in the database.
     */
