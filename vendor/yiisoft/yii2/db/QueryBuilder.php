...
class QueryBuilder extends \yii\base\BaseObject
{
     ...
     * Creates a SQL View.
     *
     * @param string $viewName the name of the views to be created.
     * @param string|Query $subQuery the select statement which defines the views.
     ...
     * Drops a SQL View.
     *
     * @param string $viewName the name of the views to be dropped.
