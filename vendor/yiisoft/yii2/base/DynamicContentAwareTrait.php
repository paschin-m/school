...
trait DynamicContentAwareTrait
{
    ...
    /**
     * Returns the views object that can be used to render views or views files using dynamic contents.
     * @return View the views object that can be used to render views or views files.
     */
