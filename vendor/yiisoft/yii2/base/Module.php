 ...
 * @property string $viewPath The root directory of views files. Defaults to "[[basePath]]/views".
 *
...
class Module extends ServiceLocator
{
    ...
    public $module;
    /**
     * @var string|bool the layout that should be applied for views within this module. This refers to a views name
    ...
    private $_basePath;
    /**
     * @var string the root directory that contains views files for this module
     */
    private $_viewPath;
    /**
     * @var string the root directory that contains layout views files for this module.
     */
    private $_layoutPath;
    /**
    ...
    /**
     * Returns the directory that contains the views files for this module.
     * @return string the root directory of views files. Defaults to "[[basePath]]/views".
     */
    ...
    /**
     * Returns the directory that contains layout views files for this module.
