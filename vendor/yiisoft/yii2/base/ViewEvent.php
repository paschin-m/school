...
{
    /**
     * @var string the views file being rendered.
     */
    public $viewFile;
    /**
    ...
    public $output;
    /**
     * @var bool whether to continue rendering the views file. Event handlers of
     * [[View::EVENT_BEFORE_RENDER]] may set this property to decide whether
     * to continue rendering the current views file.
     */
    public $isValid = true;
}
