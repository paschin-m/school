 ...
 * [[basePath]].
 * @property View|\yii\web\View $views The views application component that is used to render various views
...
abstract class Application extends Module
{
     ...
     * the language that the messages and views files are written in.
     * @see language
     */
     ...
     * @return View|\yii\web\View the views application component that is used to render various views files.
     */
