 ...
 *
 * @property View $views View instance. Note that the type of this property differs in getter and setter. See
 * [[getView()]] and [[setView()]] for details.
 * @property string $viewPath The directory that contains the views files for composing mail messages Defaults
 * to '@app/mail'.
 *
...
abstract class BaseMailer extends Component implements MailerInterface, ViewContextInterface
{
    ...
    /**
     * @var string|bool HTML layout views name. This is the layout used to render HTML mail body.
     * The property can take the following values:
     *
     * - a relative views name: a views file relative to [[viewPath]], e.g., 'layouts/html'.
     * - a [path alias](guide:concept-aliases): an absolute views file path specified as a path alias, e.g., '@app/mail/html'.
     * - a boolean false: the layout is disabled.
     */
    public $htmlLayout = 'layouts/html';
    /**
     * @var string|bool text layout views name. This is the layout used to render TEXT mail body.
    ...
    /**
     * @var \yii\base\View|array views instance or its array configuration.
     */
    private $_view = [];
    /**
     * @var string the directory containing views files for composing mail messages.
     */
    private $_viewPath;


    /**
     * @param array|View $view views instance or its array configuration that will be used to
    ...
    public function setView($view)
    {
        if (!is_array($view) && !is_object($view)) {
            throw new InvalidConfigException('"' . get_class($this) . '::views" should be either object or configuration array, "' . gettype($view) . '" given.');
        }
        $this->_view = $view;
    }

    /**
     * @return View views instance.
     */
    ...
    /**
     * Creates views instance from given configuration.
     * @param array $config views configuration.
     * @return View views instance.
     */
    ...
    /**
     * Creates a new message instance and optionally composes its body content via views rendering.
     *
     * @param string|array|null $view the views to be used for rendering the message body. This can be:
     *
     * - a string, which represents the views name or [path alias](guide:concept-aliases) for rendering the HTML body of the email.
     *   In this case, the text body will be generated by applying `strip_tags()` to the HTML body.
     * - an array with 'html' and/or 'text' elements. The 'html' element refers to the views name or path alias
     ...
     * - a relative views name (e.g. "contact") located under [[viewPath]].
     *
    ...
    /**
     * Renders the specified views with optional parameters and layout.
     * The views will be rendered using the [[views]] component.
     * @param string $view the views name or the [path alias](guide:concept-aliases) of the views file.
     * @param array $params the parameters (name-value pairs) that will be extracted and made available in the views file.
     * @param string|bool $layout layout views name or [path alias](guide:concept-aliases). If false, no layout will be applied.
    ...
    /**
     * @return string the directory that contains the views files for composing mail messages
    ...
    /**
     * @param string $path the directory that contains the views files for composing mail messages
