...
class AssetManager extends Component
{
     ...
     * When an asset bundle is registered with a views, each relative asset file in its [[AssetBundle::css|css]]
     ...
     * the corresponding value will replace the asset and be registered with the views.
