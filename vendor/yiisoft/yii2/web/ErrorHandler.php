...
class ErrorHandler extends \yii\base\ErrorHandler
{
    ...
    public $errorAction;
    /**
     * @var string the path of the views file for rendering exceptions without call stack information.
     */
    public $errorView = '@yii/views/errorHandler/error.php';
    /**
     * @var string the path of the views file for rendering exceptions.
     */
    public $exceptionView = '@yii/views/errorHandler/exception.php';
    /**
     * @var string the path of the views file for rendering exceptions and errors call stack element.
     */
    public $callStackItemView = '@yii/views/errorHandler/callStackItem.php';
    /**
     * @var string the path of the views file for rendering previous exceptions.
     */
    ...
    public function renderFile($_file_, $_params_)
    {
        ...
        if ($this->exception instanceof ErrorException || !Yii::$app->has('views')) {
            ob_start();
