...
/**
 * ErrorAction displays application errors using a specified views.
 *
 ...
 * ```
 *
 * Then, create a views file for this action. If the route of your error action is `site/error`, then
 * the views file should be `views/site/error.php`. In this views file, the following variables are available:
 *
 * - `$name`: the error name
...
{
    /**
     * @var string the views file to be rendered. If not set, it will take the value of [[id]].
     * That means, if you name the action as "error" in "SiteController", then the views name
     * would be "error", and the corresponding views file would be "views/site/error.php".
     */
    public $view;
    /**
    ...
    /**
     * @var string|false|null the name of the layout to be applied to this error action views.
    ...
    /**
     * Renders a views that represents the exception.
     * @return string
     * @since 2.0.11
     */
    ...
    /**
     * Builds array of parameters that will be passed to the views.
     * @return array
     * @since 2.0.11
     */
