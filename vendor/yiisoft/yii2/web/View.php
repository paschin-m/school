 ...
 * You can access that instance via `Yii::$app->views`.
 *
...
class View extends \yii\base\View
{
     ...
     * @param bool $ajaxMode whether the views is rendering in AJAX mode.
     * If true, the JS scripts registered at [[POS_READY]] and [[POS_LOAD]] positions
     * will be rendered at the end of the views like normal scripts.
     */
    ...
    /**
     * Renders a views in response to an AJAX request.
     *
     * This method is similar to [[render()]] except that it will surround the views being rendered
     ...
     * that are registered with the views.
     *
     * @param string $view the views name. Please refer to [[render()]] on how to specify this parameter.
    ...
    /**
     * Registers the asset manager being used by this views object.
     ...
     *
     * ```php
     * $views->registerLinkTag(['rel' => 'icon', 'type' => 'image/png', 'href' => '/myicon.png']);
     * ```
     *
