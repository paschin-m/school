 ...
 * with a views, all its dependent asset bundles will be automatically registered.
 *
...
class AssetBundle extends BaseObject
{
    ...
    /**
     * Registers this asset bundle with a views.
     * @param View $view the views to be registered with
    ...
    /**
     * Registers the CSS and JS files with the given views.
     * @param \yii\web\View $view the views that the asset files are to be registered with.
     */
