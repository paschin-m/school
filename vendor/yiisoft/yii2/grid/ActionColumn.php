...
class ActionColumn extends Column
{
     ...
     * specified in [[buttons]]. For example, the token `{views}` will be replaced by the result of
     * the callback `buttons['views']`. If a callback cannot be found, the token will be replaced with an empty string.
     *
     * As an example, to only have the views, and update button you can add the ActionColumn to your GridView columns as follows:
     *
     * ```php
     * ['class' => 'yii\grid\ActionColumn', 'template' => '{views} {update}'],
     * ```
     *
     * @see buttons
     */
    ...
    {
        $this->initDefaultButton('views', 'eye-open');
