 ...
 *
 * The look and feel of a grid views can be customized using the large amount of properties.
 *
...
class GridView extends BaseListView
{
    ...
    /**
     * @var array the HTML attributes for the container tag of the grid views.
    ...
    /**
     * @var bool whether to show the grid views if [[dataProvider]] returns no data.
     */
    ...
    /**
     * @var string the layout that determines how different sections of the grid views should be organized.
    ...
    /**
     * Returns the options for the grid views JS widget.
