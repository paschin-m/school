...
class BaseUrl
{
     ...
     *
     * A relative route is a route without a leading slash, such as "views", "post/views".
     *
     * - If the route is an empty string, the current [[\yii\web\Controller::route|route]] will be used;
     ...
     * [[\yii\web\Controller::actionParams]]. You may use the following code in the layout views to add a link tag
     * about canonical URL:
     *
     * ```php
     ...
     *
     * ```php
     * // assume $_GET = ['id' => 123, 'src' => 'google'], current route is "post/views"
     *
